...
namespace Manifest_Math
{
	struct MFvec3
	{
		constexpr MFvec3() : x{ 0 }, y{ 0 }, z{ 0 } {};
		constexpr MFvec3(const MFfloat uniform) : //ex call v + 2 -> v + v{uniform}
			x{ uniform }, y{ uniform }, z{ uniform }
		{};
		constexpr MFvec3(const MFfloat _x, const MFfloat _y, const MFfloat _z) :
			x{ _x }, y{ _y }, z{ _z }
		{};
